...
from modules.simulation.run_parse import Runner
...
class Fuzzer(object):
    ...
    def __init__(self, cfgs):
        ...
        self.load_json(cfgs['scenario_env_json'])
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Apollo Testing.')
    parser.add_argument('--config', type=str, help='Test config yaml file.', default='/mnt/sda/Mystique/src/configs/config.yaml')
